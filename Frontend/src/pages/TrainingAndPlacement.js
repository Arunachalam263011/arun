...
import Event3 from '../images/staff3.avif';
...
const TrainingAndPlacement = () => {
  ...
  return (
    <Container style={{ marginBottom: '6rem' }}>
      <Typography variant="h4" align="center" fontWeight="600" style={{ color: '#030637',fontFamily:'serif' }} gutterBottom>
      ...
      <div style={{ display: 'flex', justifyContent: 'center', marginTop: '2rem' }}>
        {showAll ? (
          <Button variant="contained" style={{ backgroundColor: '#030637', color: 'white' }} onClick={toggleShowAll}>
            View Less
          </Button>
        ) : (
          <Button variant="contained" style={{ backgroundColor: '#030637', color: 'white' }} onClick={toggleShowAll}>
