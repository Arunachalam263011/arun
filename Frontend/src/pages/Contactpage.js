                ...
                <div className="rs-contact-box">
                  <div className="address-item horizontal">
                    <div className="address-icon">
                      <Phone style={{fontSize:'3rem',position:'relative',right:'4rem',top:'3rem',color:'#030637'}} />
                    </div>
                    <div className="address-text" >
                      <div className="phone">
                        <span className="label" style={{fontSize:'1.5rem',fontWeight:'900',color:'#030637'}}>Phone</span><br/>
                  ...
                  <div className="address-item horizontal">
                    <div className="address-icon">
                      <Email style={{fontSize:'3rem',position:'relative',right:'4rem',top:'3rem',color:'#030637'}} />
                    </div>
                    <div className="address-text">
                      <div className="email">
                        <span className="label"  style={{fontSize:'1.5rem',fontWeight:'900',color:'#030637'}}>Email</span><br/>
                  ...
                  <div className="address-item horizontal">
                    <div className="address-icon">
                      <LocationOn style={{fontSize:'3rem',position:'relative',right:'4rem',top:'3rem',color:'#030637'}}/>
                    </div>
                    <div className="address-text">
                      <div className="text">
                        <span className="label"  style={{fontSize:'1.5rem',fontWeight:'900',color:'#030637'}}>Location</span><br/>
                        <span className="des">
