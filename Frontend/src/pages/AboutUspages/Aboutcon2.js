...
import Banner from "../../images/About2.png";
      ...
      <StyledContainer sx={{ position: 'relative' }}>
        <Grid container spacing={2} alignItems="center">
          <Grid item xs={12} sm={6} order={{ xs: 2, sm: 1 }}>
            <Typography variant="h4" align="center" style={{fontWeight:'700',color:'#030637',fontFamily:'serif'}} >
            OUR BELIEF
            ...
            <br />
             {/* <Link to="/menu">
              <Button className="Enquirybutton" variant="contained" style={{ backgroundColor: "#030637", color: 'white',fontFamily:'serif' }}>
                Apply Now
              </Button>
            </Link>  */}
          </Grid>
