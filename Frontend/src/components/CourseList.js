  ...
  return (
    <>
      <div className="App" style={containerStyle}>
        <Button
          className="button"
          style={{ margin: "30px auto 20px", display: "block", background: '#1B3C73', color: "white", fontSize: '1rem', fontWeight: '600',position:'relative',right:'21.4rem',top:'3.7rem',fontFamily:'serif' }}
        ...
        variant="outlined"
        // ... (button styles)
        onClick={openModal} style={{background:'#1B3C73',color:" white",fontFamily:'serif',fontSize:'1rem',fontWeight:'600',position:'relative'}}// Open the AddCourse modal when this button is clicked
      >
      <AddIcon/>  Add Course
      </Button>
            ...
            {filteredCourses.map((course, index) => (
              ...
              <td style={{width:'2rem'}}>
                <Button
                  ...
                  style={{ marginBottom: "5px", backgroundColor: "#d3e3e3",color:' white' }}
                >
                 <EditIcon/>
                </Button>
                <Button style={{ backgroundColor: "#1B3C73",color:'white' }}>
