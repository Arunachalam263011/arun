...
const [modalShow,setModalShow] = useState(false)
  ...
  style={{ margin: "30px auto 20px", display: "block" ,position:'relative',left:'27rem',top:'3rem',background:'#1B3C73',color:" white",fontSize:'1rem',fontWeight:'600'}}
>
  Export to Excel
</Button>
    <Button
        variant="outlined"
        // ... (button styles)
        onClick={openModal}  style={{background:'#1B3C73',color:" white",fontFamily:'serif',fontSize:'1rem',fontWeight:'600',position:'relative',right:'3rem'}}// Open the AddCourse modal when this button is clicked
      >
        Add Category
      </Button>
  ...
  style={{ backgroundColor: "#d3e3e3",color:' white' }}
>
